    ...
    <div class="p-12 md:p-24 pb-0 mb-auto w-full">
        ...
        >
            ...
            <div class="flex flex-col sm:flex-row sm:justify-center sm:items-center">
                ...
                <div class="flex justify-start items-center gap-1 h-[2.5rem]" style="color:#718096">
                    <a href="https://www.linkedin.com/in/ken-lee-461986303" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" width="1.5rem" height="1.5rem" x="0px" y="0px" viewBox="0 0 50 50" fill="white">
                            <path d="M41,4H9C6.24,4,4,6.24,4,9v32c0,2.76,2.24,5,5,5h32c2.76,0,5-2.24,5-5V9C46,6.24,43.76,4,41,4z M17,20v19h-6V20H17z M11,14.47c0-1.4,1.2-2.47,3-2.47s2.93,1.07,3,2.47c0,1.4-1.12,2.53-3,2.53C12.2,17,11,15.87,11,14.47z M39,39h-6c0,0,0-9.26,0-10 c0-2-1-4-3.5-4.04h-0.08C27,24.96,26,27.02,26,29c0,0.91,0,10,0,10h-6V20h6v2.56c0,0,1.93-2.56,5.81-2.56 c3.97,0,7.19,2.73,7.19,8.26V39z"></path>
                        </svg>
                    </a>
                    
                    <a href="https://github.com/Ryuuu825" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" width="1.5rem" height="1.5rem" x="0px" y="0px" viewBox="0 0 50 50" fill="white">
        ...
        <div
            class="sm:flex flex-row justify-between md:pt-10 sm:pt-10 w-full border-b pb-3 border-gray-500 z-[99] sm:sticky top-0 "
            style="background-color: #212529;"
        >
            <div class="hidden sm:flex sm:flex-row w-max text-center" style="color:#718096">
                ...
                >
                <a
                    class="nav-link px-4 h-[1.9rem] bg-gray-200 text-black text-center py-1 rounded-sm cursor-pointer select-none ml-3"
                    style="color:#000"
                    href="#/resume"
